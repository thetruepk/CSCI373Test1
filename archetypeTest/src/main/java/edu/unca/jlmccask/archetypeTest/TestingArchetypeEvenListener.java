package edu.unca.jlmccask.archetypeTest;
...
public class TestingArchetypeEvenListener implements Listener {

	private TestingArchetype plugin;

	public TestingArchetypeEvenListener(TestingArchetype plugin) {
		this.plugin = plugin;
	}
